  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        title: Text("Group 25",style: TextStyle(color:  Color.fromARGB(255, 81, 6, 0)),),
      ),
      body: Container(
          ...
          children: [
            (imageSelect)?Center(
              ...
              child: const Opacity(
                opacity: 0.3,
                child: Center(
                  child: Text("No Images Selected",style: TextStyle(fontWeight: FontWeight.bold,fontSize: 20),),
                ),
              ),
            ),
